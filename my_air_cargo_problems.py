            ...
            for airport in self.airports:
                for cargo in self.cargos:
                    for plane in self.planes:
                        ...
                        load = Action(expr("Load({}, {}, {})".format(cargo, plane, airport)),[precond_pos,precond_neg],[effect_pos,effect_neg])
                        loads.append(load)
            return loads
            ...
            for airport in self.airports:
                for cargo in self.cargos:
                    for plane in self.planes:
                        ...
                        unload = Action(expr("Unload({}, {}, {})".format(cargo, plane, airport)),[precond_pos,precond_neg],[effect_pos,effect_neg])
